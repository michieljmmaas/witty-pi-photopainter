# encoding: utf-8
# Based on the Waveshare RPi Zero PhotoPainter conversion script
# (https://www.waveshare.com/wiki/RPi_Zero_PhotoPainter).
# Additions: HEIC support, rich progress bar.
